...
var viewAllCategoryRouter = require('./routes/view-all-category');
...
app.use('/', indexRouter);
app.use('/password-management-system', dashboardRouter);
app.use('/add-new-category', addNewCategoryRouter);
app.use('/view-all-category', viewAllCategoryRouter);
